function GenerateReport(evidence) {
    ...
    html_header += "<div id=\"header_title\">" + 'TODISTE RAPORTTI' + "</div>";
    html_header += "<div id=\"header_seal\"></div>";
    html_header += "<div id=\"header_details\"><h2>" + 'Virallinen virkavallan rikostekninen ryhmä raportoi annetuista todisteista!' + "</h2>";
    ...
    for (i = 0; i < Object.keys(evidence).length; i++) {
        ...
        html_middle += "<div id=\"section_footer_block\">" + 'TODISTE #' + (i + 1) + ' (' + evidence[i]["type"] + ')' + "</div>";
