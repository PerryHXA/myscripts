...
AddEventHandler('Oku_Accounts:getAccount', function(name, owner, cb)
	cb(GetAccount(name, owner))
end)

AddEventHandler('Oku_Accounts:getSharedAccount', function(name, cb)
...
VorpCore.addRpcCallback('Oku_Accounts:HaePalkatut', function(source, cb, society) 
...
VorpCore.addRpcCallback('Oku_Accounts:HaePelaajat', function(source, cb) 
	local _perm = tonumber(source)
...
VorpCore.addRpcCallback('Oku_Accounts:HaePelaajat', function(source, cb, society)
	local src = source
...
VorpCore.addRpcCallback('Oku_Accounts:HaeTiedotJob', function(source, cb)
	local _source = source
...
VorpCore.addRpcCallback('Oku_Accounts:HowMany', function(source, cb, job)
	local players = GetPlayers()
	local jobcount = 0
